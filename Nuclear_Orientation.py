...
The thermometer material selection is done in module 'material.py'.
Usually 60Co in hcp Co at Oxford Instruments.
...
def B2(J, T):
    ...
    roottop = (2 * J + 1) * 5 * math.factorial(2 * J - 2)
    rootbot = math.factorial(2 * J + 3)

    b2_result = 6 * (J ** 2) * math.sqrt(roottop / rootbot) * f2(J, T)
    return b2_result
